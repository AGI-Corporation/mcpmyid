# About Activepieces Route.X

Activepieces Route.X is the world's first research-backed operating system designed specifically for the **Internet of Agents**. It transforms static automation workflows into dynamic, self-correcting capabilities that any AI agent (Claude, Mistral, GPT) can use with 99% reliability.
...
To enable this, Route.X provides:
...
## Why Research-Backed?
Every feature in Route.X is grounded in peer-reviewed AI research (from ODIA to STEER). We don't just build features; we implement proven techniques to maximize the **F1 score** and **On-Device Ratio** of your AI integrations.

## Route.X Overview Diagram

```mermaid
graph TD
    A[Autonomous Agents] -->|NANDA Discovery| B(Activepieces Route.X)
